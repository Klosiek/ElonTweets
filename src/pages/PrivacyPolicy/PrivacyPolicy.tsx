...
const PrivacyPolicy = () => {
  return (
    <div>
      <Heading>Privacy Policy for filtrelon</Heading>

      <Text>
        At filtrelon, accessible from filtrelon.web.app, one of our main priorities is the privacy of our visitors. This
        Privacy Policy document contains types of information that is collected and recorded by filtrelon and how we use
        it.
      </Text>
      ...
      <Text>
        ...
        to the information that they shared and/or collect in filtrelon. This policy is not applicable to any
      ...
      <Text>
        filtrelon follows a standard procedure of using log files. These files log visitors when they visit websites.
      ...
      <Text>
        You may consult this list to find the Privacy Policy for each of the advertising partners of filtrelon.
      </Text>

      <Text>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on filtrelon, which are sent directly to users'
      ...
      <Text>
        Note that filtrelon has no access to or control over these cookies that are used by third-party advertisers.
      </Text>

      <Heading size="lg">Third Party Privacy Policies</Heading>

      <Text>
        filtrelon's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
      ...
      <Heading size="lg">CCPA Privacy Rights (Do Not Sell My Personal Information)</Heading>
      ...
      <List spacing="8px">
        ...
        <ListItem>
          ...
          conditions. Please contact us at <strong>filtrelon@gmail.com</strong>
        </ListItem>
        <ListItem>
      ...
      <Text>
        If you make a request, we have one month to respond to you. If you would like to exercise any of these rights,
        please contact us at <strong>filtrelon@gmail.com</strong>.
      </Text>
      ...
      <Text>
        filtrelon does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
